import img1 from "./Products/Apples.webp";
import img2 from "./Products/BabySpinach.webp";
import img3 from "./Products/BrusselsSprouts.webp";
import img4 from "./Products/CelerySticks.webp";
import img5 from "./Products/blueberries.webp";
import img6 from "./Products/clementines.webp";
import img7 from "./Products/Corn.webp";
import img8 from "./Products/Cucumber.webp";
import img9 from "./Products/Dates.webp";
import img10 from "./Products/FrenchGreenBeans.webp";
import img11 from "./Products/GreenBeans.webp";
import img12 from "./Products/GreenLimes.webp";
import img13 from "./Products/Mangoes.webp";
import img14 from "./Products/MiniPeppers.webp";
import img15 from "./Products/swordfish_smniuv.webp";
import img16 from "./Products/strawberry.webp";
import img17 from "./Products/sliced_turkey_breast_szb8jg.webp";
import img18 from "./Products/pears.webp";
import img19 from "./Products/halibut_jaz7ju.webp";
import img20 from "./Products/codfillet_u0mti1.webp";
import img21 from "./Products/beef_xkxhnb.webp";
import img22 from "./Products/TilapiaFillet_a2urhk.webp";
import img23 from "./Products/Yellow-Limes.webp";
import img24 from "./Products/Peeled-Carrots.webp";
import img25 from "./Products/RedCherries.webp";
import img26 from "./Products/SignatureSalmon_fstp4m.webp";
import img27 from "./Products/TilapiaFillet_a2urhk.webp";
...
export const products = [
  ...
  },
  {
    ...
    imageUrl: img22,
    category: "Fish",
    description:"Tilapia is the common name for nearly a hundred species of cichlid fish from the coelotilapine, coptodonine, heterotilapine, oreochromine, pelmatolapiine and tilapiine tribes, with the economically most important species placed in Coptodon, Oreochromis, Sarotherodon, and Tilapia."
  },
  {
    id: 23,
    weight: "1lb",
  ...
  },
  {
    ...
    imageUrl: img24,
    category: "Vegetables",
    description:"Carrot is a root vegetable, usually orange in color, though purple, black, red, white, and yellow cultivars exist. The domesticated carrot (Daucus carota subsp. sativus) is a biennial plant, grown as an annual, commonly cultivated for its edible taproot."
  },
  {
    id: 25,
    weight: "1lb",
    ...
    imageUrl: img25,
    category: "Fruits",
    description:"A cherry is the fruit of many plants of the genus Prunus, and is a fleshy drupe (stone fruit). As a food, cherries are usually sweet or sour, and are used in culinary dishes, jams, or beverages."
  },
  {
    id: 26,
    weight: "1lb",
    ...
    imageUrl: img26,
    category: "Fish",
    description:"Salmon is a popular fish known for its delicate pink flesh and mild flavor. It is commonly found in oceans, especially the Pacific and Atlantic. Salmon is often served fresh, smoked, or preserved."
  },
  {
    id: 27,
    weight: "1lb",

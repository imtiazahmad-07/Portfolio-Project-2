...
export const ProductDetails = [
  ...
  },
  {
    ...
    category: "Fish",
    description:
      "Tilapia is the common name for nearly a hundred species of cichlid fish from the coelotilapine, coptodonine, heterotilapine, oreochromine, pelmatolapiine and tilapiine tribes, with the economically most important species placed in Coptodon, Oreochromis, Sarotherodon, and Tilapia.",
  },
  {
    id: 23,
    weight: "1lb",
  ...
  },
  {
    ...
    category: "Vegetables",
    description:
      "Carrot is a root vegetable, usually orange in color, though purple, black, red, white, and yellow cultivars exist. The domesticated carrot (Daucus carota subsp. sativus) is a biennial plant, grown as an annual, commonly cultivated for its edible taproot.",
  },
  {
    id: 25,
    weight: "1lb",
    ...
    category: "Fruits",
    description:
      "A cherry is the fruit of many plants of the genus Prunus, and is a fleshy drupe (stone fruit). As a food, cherries are usually sweet or sour, and are used in culinary dishes, jams, or beverages.",
  },
  {
    id: 26,
    weight: "1lb",
    ...
    category: "Fish",
    description:
      "Salmon is a popular fish known for its delicate pink flesh and mild flavor. It is commonly found in oceans, especially the Pacific and Atlantic. Salmon is often served fresh, smoked, or preserved.",
  },
  {
    id: 27,
    weight: "1lb",
